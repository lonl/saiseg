...
from segcore.models.utils import *


class Linknet(nn.Module):
    def __init__(self, feature_scale=4, n_classes=6, is_deconv=True, in_channels=3, is_batchnorm=True):
        ...
        self.convbnrelu1 = conv2DBatchNormRelu(
            in_channels=3, k_size=7, n_filters=filters[0], padding=3, stride=2, bias=False
        )
        ...
        self.finaldeconvbnrelu1 = nn.Sequential(
            nn.ConvTranspose2d(filters[0], 32 / feature_scale, 4, 2, 1),   # pay attention for the kernel size
        ...
        self.finalconv3 = nn.Conv2d(32 / feature_scale, n_classes, 1, 1, 0)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        self.inplanes = planes * block.expansion # update the inplanes
